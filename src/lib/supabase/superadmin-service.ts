...
const DB_TABLES: { table: string; label: string; category: DbTableStat["category"] }[] = [
  ...
  { table: "biosafety_risk_assessments", label: "BioRisk Assessments", category: "ai" },
  { table: "biotype_foundations",      label: "Biotype Foundations",  category: "ai" },
  { table: "provider_profiles",        label: "Providers",            category: "core" },
  { table: "compliance_programs",      label: "Programs",             category: "compliance" },
  { table: "change_plan_items",        label: "Change Plan Items",    category: "compliance" },
  { table: "incidents",                label: "Incidents",            category: "compliance" },
  { table: "controlled_work_permits",  label: "Permits",              category: "compliance" },
];
