...
export const SETUP_QUESTIONS: SetupQuestion[] = [
  ...
  { number: 5, domain: "Biological Materials", text: "Do you use unknown biological material or diagnostic samples?", kind: "boolean", triggers: ["Biosafety", "Diagnostic Lab / CLIA / HIPAA"] },
  ...
  { number: 10, domain: "Manufacturing & Quality", text: "Do you manufacture instruments, diagnostics, devices, labware, drugs, biologics, or regulated medical products?", kind: "boolean", triggers: ["Medical Device / Labware", "Instrument Manufacturing / Service", "Pharma/Biologics Manufacturing"] },
  { number: 11, domain: "Manufacturing & Quality", text: "Do you operate cleanrooms, sterile areas, or controlled environments?", kind: "boolean", triggers: ["Cleanroom / Controlled Environment"] },
  ...
  { number: 23, domain: "Manufacturing & Quality", text: "Do records from this platform support GxP, Part 11, batch, lot, device, clinical, or quality records?", kind: "boolean", triggers: ["GxP / Part 11 / Data Integrity"] },
  { number: 24, domain: "Manufacturing & Quality", text: "Do diagnostic workflows include patient identifiers, PHI, chain-of-custody, CLIA, CAP, or customer accreditation requirements?", kind: "boolean", triggers: ["Diagnostic Lab / CLIA / HIPAA", "Security / Access Control"] },
