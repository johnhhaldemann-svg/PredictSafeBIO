...
- PR #37 merged selected-task bulk activity notes while preserving owner/member task-assignment boundaries.
- PR #39 merged explicit selected-task bulk closeout with a required closeout note and the same owner/member task-assignment boundaries.
...
- Signed-in production owner/member bulk-note smoke passed on June 1, 2026 after PR #37 promoted: bulk note controls rendered for selected tasks, selected counts synced, and bulk priority/assignment/due-date controls were not exposed.
- Signed-in production owner/member bulk-closeout smoke passed on June 1, 2026 after PR #39 promoted: bulk closeout controls rendered, selected counts synced, and bulk priority/assignment/due-date controls were not exposed.
