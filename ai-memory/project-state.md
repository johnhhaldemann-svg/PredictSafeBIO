...
- Branch `codex/bulk-task-closeout` adds explicit selected-task bulk closeout with a required closeout note and the same owner/member task-assignment boundaries.
